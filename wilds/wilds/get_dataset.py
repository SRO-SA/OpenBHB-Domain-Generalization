...
def get_dataset(dataset: str, version: Optional[str] = None, unlabeled: bool = False, **dataset_kwargs):
    ...
    elif dataset == 'openBHB':
        if unlabeled:
            from wilds.datasets.unlabeled.openbhb_unlabeled_dataset import OpenBHBUnlabeledDataset
            return OpenBHBUnlabeledDataset(version=version, **dataset_kwargs)
        else :
            from wilds.datasets.openbhb_dataset import OpenBHBDataset
            return OpenBHBDataset(version=version, **dataset_kwargs)
