...
class WILDSDataset:
    ...
    def initialize_data_dir(self, root_dir, download, harmonized=None):
        """
        ...
        if harmonized is None :
            harmonized = ''
        data_dir = os.path.join(root_dir, f'{self.dataset_name}_v{self.version}{harmonized}')
        version_file = os.path.join(data_dir, f'RELEASE_v{self.version}{harmonized}.txt')
    ...
    def dataset_exists_locally(self, data_dir, version_file):
        ...
        print(data_dir, " version file: ", version_file)
